...
|:----------|:---------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| PUT       | `/api/v1/reservations/merchants/{merchantId}/orders/{orderId}{}` | Captures the transaction, i.e. carries out the actual payment. <br><br>It is important to know which capture type to use, since it must match the reservation type. See Reservation- and Capture Types for further information. <br><br>Note that {} is mandatory after orderId. To Capture the full amount simply leave {} empty.|
